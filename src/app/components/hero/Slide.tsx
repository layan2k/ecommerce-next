...
const Slide: React.FC<SlideProps> = ({ img, title, mainTitle, price }) => {
    return (
        <section className="outline-none border-none relative">
            <div className="absolute left-[30px] md:left[70px] max-w-[250px] sm:max-w-[350px] top-[50%] -translate-y-[50%] space-y-2 lg:space-y-4
            ...
            <div className="flex max-h-[500px] items-center justify-center">
                <Image
                    className="image__hero__bg w-[100%] h-[300px] md:h-auto rounded-xl object-cover object-right md:object-left-bottom"
                    src={img}
                    alt="banner"
                    width={2000}
                    height={800}
